...
- Export pipeline now attempts runtime image inlining for standalone image URLs before writing EPUB/HTML artifacts to reduce broken hotlink/expiring image references in reader output
